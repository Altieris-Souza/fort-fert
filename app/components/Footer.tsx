      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">Fort Fert</span>
            </div>
            <p className="text-zinc-400 leading-relaxed">
              Serviços profissionais de caminhão e produção própria de tomates de estufa.
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:shadow-yellow-500/50 transition-all duration-300"
              >
              ...
              <a
                href="https://www.instagram.com/a1fortfert/"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-zinc-800 pt-8">
          <p className="text-center text-zinc-500 text-sm">
            © {new Date().getFullYear()} Fort Fert. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
